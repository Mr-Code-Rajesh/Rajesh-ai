...
export default function ChatPage() {
  ...
  const [isSidebarCollapsed, setIsSidebarCollapsed] = useState(true); // Default to collapsed for mobile-first

  // Handle auto-collapse on mobile initial load
  useEffect(() => {
    const checkMobile = () => {
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {!activeThreadId && messages.length === 0 ? (
                <div className="text-center mb-10 space-y-4 pt-12 md:pt-16 pb-4">
                  <motion.h1
                  ...
                  <p className="text-zinc-500 text-sm md:text-base max-w-xl mx-auto font-medium px-4">
